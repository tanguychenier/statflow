...
/**
 * POST /api/v1/analytics/{site_id}/breakdown (openapi.yaml `getBreakdown`).
 */
#[Route(
    '/api/v1/analytics/{site_id}/breakdown',
...
final readonly class BreakdownController
{
    public function __construct(
        private BreakdownHandler $handler,
    ...
    public function __invoke(Request $request, string $site_id): JsonResponse
    {
        try {
            ...
            $query = $this->factory->breakdownQuery($siteId, $body);
