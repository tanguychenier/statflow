...
/**
 * POST /api/v1/analytics/{site_id}/funnels (openapi.yaml `queryFunnel`).
 */
#[Route(
    '/api/v1/analytics/{site_id}/funnels',
    name: 'analytics_funnel_query',
    methods: ['POST'],
)]
final readonly class FunnelQueryController
{
    public function __construct(
        private FunnelHandler $handler,
    ...
    public function __invoke(Request $request, string $site_id): JsonResponse
    {
        try {
            ...
            $query = $this->factory->funnelQuery($siteId, $body);
