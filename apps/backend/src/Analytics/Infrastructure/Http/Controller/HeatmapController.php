...
/**
 * POST /api/v1/analytics/{site_id}/heatmap (openapi.yaml `queryHeatmap`).
 */
#[Route(
    '/api/v1/analytics/{site_id}/heatmap',
    name: 'analytics_heatmap',
    methods: ['POST'],
)]
final readonly class HeatmapController
{
    public function __construct(
        private HeatmapHandler $handler,
    ...
    public function __invoke(Request $request, string $site_id): JsonResponse
    {
        try {
            ...
            $query = $this->factory->heatmapQuery($siteId, $body);
